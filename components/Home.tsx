...
export const Home: React.FC = () => {
  return (
    <div className="relative z-10 w-full max-w-7xl mx-auto transition-all duration-700">
      ...
      <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[15vw] md:text-[20vw] font-bold text-gray-100 opacity-60 pointer-events-none select-none whitespace-nowrap font-vt323 leading-none z-[-1] blur-sm fixed">
         MICHELLE
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start">
        {/* Left Column: Home Base */}
        <div className="text-center md:text-left space-y-4 md:space-y-6 pt-6 md:pt-20 md:sticky md:top-24">
          <div className="flex items-center justify-center md:justify-start gap-2 md:gap-4 text-gray-400 font-mono text-[8px] md:text-xs tracking-[0.3em] md:tracking-[0.5em] animate-pulse">
             <span>⛓</span>
          ...
          <div className="text-3xl md:text-5xl font-bold text-black tracking-widest flicker-text">
                       <GlitchText text="MICHELLE_WENG" textClassName="text-black glitch-home-style" />
                     </div>
          
          {/* Compact Bio */}
          <div className="max-w-xl mx-auto md:mx-0 space-y-3 md:space-y-4">
             <div className="text-xs md:text-lg text-gray-600 font-serif italic tracking-widest">
                cloud_surfing...
             </div>
             
             <p className="text-gray-800 font-mono text-[11px] md:text-sm leading-relaxed text-justify md:text-left border-t border-b border-gray-200 py-3 md:py-4">
             ...
             <div className="flex flex-wrap justify-center md:justify-start gap-3 md:gap-4 text-[9px] md:text-[10px] font-mono text-gray-500 uppercase tracking-wider">
        ...
        <div id="blog" className="w-full mt-6 md:mt-0 scroll-mt-24">
