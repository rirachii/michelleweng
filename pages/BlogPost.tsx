    ...
    return (
      <Layout>
        <div className="flex flex-col items-center justify-center min-h-[50vh] text-center space-y-4">
          ...
          <Link to="/" className="text-gray-500 hover:text-black underline font-mono">
            &lt;&lt; RETURN_TO_ROOT
          </Link>
        </div>
      </Layout>
  ...
  return (
    <Layout activeSection="blog">
      <div className="max-w-3xl mx-auto py-20 space-y-8">
        <Link to="/" className="text-xs font-mono text-gray-400 hover:text-black transition-colors flex items-center gap-2 group mb-8">
